    ...
    try:
        ...
        nodes = [
            ...
            TextNode(
                ...
                id_="doc3",
                relationships={
                    NodeRelationship.SOURCE: RelatedNodeInfo(node_id="doc3")
                },
        ...
        filters = MetadataFilters(
            filters=[
                MetadataFilter(
                    key="topic", value="ml", operator=FilterOperator.EQ
                ),
            ]
        )
        q2 = VectorStoreQuery(
        ...
        filters_del = MetadataFilters(
            filters=[
                MetadataFilter(
                    key="year", value=2024, operator=FilterOperator.EQ
                ),
            ]
        )
    ...
    try:
        ...
        nodes = [
            TextNode(
                ...
                id_="fox1",
                relationships={
                    NodeRelationship.SOURCE: RelatedNodeInfo(node_id="fox1")
                },
                embedding=_get_sample_vector(0.1),
            ),
            TextNode(
                ...
                id_="ml1",
                relationships={
                    NodeRelationship.SOURCE: RelatedNodeInfo(node_id="ml1")
                },
                extra_info={"topic": "ml"},
                embedding=_get_sample_vector(1.0),
            ),
            TextNode(
                ...
                id_="fox2",
                relationships={
                    NodeRelationship.SOURCE: RelatedNodeInfo(node_id="fox2")
                },
...
def test_customize_search_fn_integration():
    ...
    try:
        ...
        node = TextNode(
            ...
            id_="test1",
            relationships={
                NodeRelationship.SOURCE: RelatedNodeInfo(node_id="test1")
            },
            embedding=_get_sample_vector(0.5),
        )
        store.add([node])
...
def test_multiple_stores_isolation():
    ...
    try:
        ...
        node_a = TextNode(
            ...
            id_="node_a",
            relationships={
                NodeRelationship.SOURCE: RelatedNodeInfo(node_id="node_a")
            },
            embedding=_get_sample_vector(1.0),
        )
        node_b = TextNode(
            ...
            id_="node_b",
            relationships={
                NodeRelationship.SOURCE: RelatedNodeInfo(node_id="node_b")
            },
            embedding=_get_sample_vector(0.1),
        )
