...
|  I-07   | SPARSE 全文搜索 (to_tsvector/to_tsquery) | `pytest tests/test_search.py::test_sparse_query -v` | 集成 |  ⏳  |
...
|  I-12   | MMR 查询 — 多样化重排序 | `pytest tests/test_search.py::TestMMRQuery -v` | 单元 |  ⏳  |
...
| 类别 | 总数 | ⏳ 待实现 | ❌ 无覆盖 | 覆盖率 |
|------|------|-----------|-----------|--------|
| required_methods | 13 | 13 | 0 | 100% |
| demo.scenarios | 9 | 9 | 0 | 100% |
| 跨方法集成 | 12 | 12 | 0 | 100% |
| **合计** | **34** | **34** | **0** | **100%** |
